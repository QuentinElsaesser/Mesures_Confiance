...
class BruteForceExperiencesParameters:
    ...
    def name_xp(self):
        if self.nvalue == constants.RUN_PRC or self.nvalue == constants.RUN_TDP:
            spe = ""
        else:
    ...
    def ask(self):
        ...
        if self.display % self.q == 0:
            ...
            print("Trust generated", [(k,self.all_trust[k]) for k in sorted(self.all_trust)])
            self.all_trust = dict()
    ...
    def run(self):
        ...
        while True:
            for i in range(self.step):
                ...
                if rG.theoritical_trust in self.all_trust:
                    self.all_trust[rG.theoritical_trust] += 1
                else:
                    self.all_trust[rG.theoritical_trust] = 1
...
def value(nvalue):
    if nvalue == constants.RUN_PRC or nvalue == constants.RUN_TDP:
        interval = ['10-14', '15-19', '20-24', '25-29', '30-34', '35-39', '40-44', '45-49', '50-54', '55-59', '60-64', '65-69', '70-74', '75-79', '80-85']
        #interval = ['40-44', '45-49']
    elif nvalue == constants.RUN_FCT:
        # interval = ["3","6","9","15","20"]
        interval = ["3","6","9","15"]
    elif nvalue == constants.RUN_SRC:
        interval = ["10","20","30","50","100"]
    elif nvalue == constants.RUN_OBJ:
